...
const db = new sqlite3.Database(dbPath, (err) => {
	if (err) return console.error(`Can't connect to database:${err.message}`)
	console.log("Connected to database as successfulu!")
})
...
app.listen(port, () => { console.log(`OnBook is running on port ${port}`) }
